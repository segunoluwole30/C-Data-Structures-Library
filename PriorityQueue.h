...
private:
    ...
    void upheap(size_type index) {
        ...
        else if (comp(c[parent(index)], c[index]))
        {
            // auto temp = c[parent(index)];
    ...
    void downheap(size_type index) {
        ...
        {
            size_type biggest = index;
            size_type left = left_child(index);
            size_type right = right_child(index);

            if (left < c.size() && comp(c[biggest], c[left]))
            {
                biggest = left;
            }

            if (right < c.size() && comp(c[biggest], c[right]))
            {
                biggest = right;
            }
        ...
        //     return;
        // }
        // if (comp(c[index],c[left_child(index)]) || comp(c[index], c[right_child(index)]))
        // {
        //     if (comp(c[left_child(index)], c[right_child(index)]))
        //     {
        //         auto temp = c[right_child(index)];
        //         c[right_child(index)] = c[index];
        //         c[index] = temp;
        //         downheap(right_child(index));
        //     }
        //     else if (comp(c[right_child(index)], c[left_child(index)]))
        //     {
        //         auto temp = c[left_child(index)];
        //         c[left_child(index)] = c[index];
        //         c[index] = temp;
